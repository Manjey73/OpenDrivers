...
namespace ScadaCommFunc
{
    public static class ConvFunc
    {
        ...
        // Converting a string to a double number with Culture check
        #region String To Double with check Culture
        public static double SToDouble(string s)
        {
            double result = 1;
        ...
        #endregion String To Double with check Culture
