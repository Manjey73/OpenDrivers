using Scada.Comm.Drivers.DrvDS18B20.View.Properties;
...
{
    internal class DsConfigProvider : ConfigProvider
    {
        /// <summary>
        ...
        /// </summary>
        public DsConfigProvider(string configDir, int deviceNum)
            : base()
        {
            varGroupsNode = null;

            ConfigFileName = Path.Combine(configDir, Ds18b20DeviceConfig.GetFileName(deviceNum));
        ...
        /// </summary>
        public Ds18b20DeviceConfig DeviceConfig => Config as Ds18b20DeviceConfig;
        ...
        {
            return string.IsNullOrEmpty(variableConfig.Name) && string.IsNullOrEmpty(variableConfig.DsId)
